...
void solve() {
    ...
    in(p_4_5);
    int e1, e2, e3, e4, e5;
    int e6 = 4 ^ 8 ^ 16 ^ 15 ^ 23 ^ 42;
    auto autoFill = poly(int num) {
        if (p_1_2 % num == 0 && p_2_3 % num == 0) {
            e2 = num;
            e1 = p_1_2 / e2;
            e3 = p_2_3 / e2;
            e4 = p_3_4 / e3;
            e5 = p_4_5 / e4;
        } else if (p_2_3 % num == 0 && p_3_4 % num == 0) {
            e3 = num;
            e2 = p_2_3 / e3;
            e4 = p_3_4 / e3;
            e1 = p_1_2 / e2;
            e5 = p_4_5 / e4;
        } else if (p_3_4 % num == 0 && p_4_5 % num == 0) {
            e4 = num;
            e3 = p_3_4 / e4;
            e5 = p_4_5 / e4;
            e2 = p_2_3 / e3;
